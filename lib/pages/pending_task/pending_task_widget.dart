                        ...
                        children: [
                          FutureBuilder<ApiCallResponse>(
                            future: (_model.apiRequestCompleter ??= Completer<
                                    ApiCallResponse>()
                                  ..complete(AdminApiGroup.pendingTaskCall.call(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final listViewPendingTaskResponse =
                                  snapshot.data!;

                              return Builder(
                                builder: (context) {
                                  final taskpending =
                                      AdminApiGroup.pendingTaskCall
                                              .records(
                                                listViewPendingTaskResponse
                                                    .jsonBody,
                                              )
                                              ?.toList() ??
                                          [];
                                  ...
                                  return RefreshIndicator(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, taskpendingIndex) {
