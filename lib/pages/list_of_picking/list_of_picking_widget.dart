...
import 'list_of_picking_model.dart';
export 'list_of_picking_model.dart';

class ListOfPickingWidget extends StatefulWidget {
  const ListOfPickingWidget({super.key});
...
class _ListOfPickingWidgetState extends State<ListOfPickingWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListOfPickingModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResult3tj = await AdminApiGroup.listOfSlotCall.call(
        robotId: FFAppState().robotid,
      );

      _model.pickingstation = functions
          .searchallpicking(
              AdminApiGroup.listOfSlotCall
                  .records(
                    (_model.apiResult3tj?.jsonBody ?? ''),
                  )
                  ?.toList(),
              '')!
          .toList()
                            ...
                            child: Padding(
                              ...
                              child: FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final columnListOfSlotResponse =
                                      snapshot.data!;
                                    ...
                                    builder: (context) {
                                      ...
                                      return SingleChildScrollView(
                                        child: Column(
                                          mainAxisSize: MainAxisSize.max,
                                          children:
                                              List.generate(slotRecords.length,
                                                  (slotRecordsIndex) {
