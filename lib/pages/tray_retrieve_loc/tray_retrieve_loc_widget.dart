...
import 'tray_retrieve_loc_model.dart';
export 'tray_retrieve_loc_model.dart';

class TrayRetrieveLocWidget extends StatefulWidget {
  const TrayRetrieveLocWidget({super.key});

  @override
  State<TrayRetrieveLocWidget> createState() => _TrayRetrieveLocWidgetState();
}

class _TrayRetrieveLocWidgetState extends State<TrayRetrieveLocWidget> {
  late TrayRetrieveLocModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrayRetrieveLocModel());
