...
export 'uplode_csv_model.dart';

class UplodeCsvWidget extends StatefulWidget {
  const UplodeCsvWidget({super.key});

  @override
  State<UplodeCsvWidget> createState() => _UplodeCsvWidgetState();
}

class _UplodeCsvWidgetState extends State<UplodeCsvWidget> {
  late UplodeCsvModel _model;
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Text(
                                          'Click here to see a sample CSV file.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
