...
import 'current_task_model.dart';
export 'current_task_model.dart';
...
class _CurrentTaskWidgetState extends State<CurrentTaskWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CurrentTaskModel());
                  ...
                  FutureBuilder<ApiCallResponse>(
                    future: (_model.apiRequestCompleter1 ??=
                            Completer<ApiCallResponse>()
                              ..complete(AdminApiGroup.taskByStatusCall.call(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final containerTaskByStatusResponse = snapshot.data!;
                      ...
                      return Container(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final stackTaskByStatusResponse = snapshot.data!;
