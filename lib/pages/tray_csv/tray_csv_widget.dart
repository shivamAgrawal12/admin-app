...
class TrayCsvWidget extends StatefulWidget {
  const TrayCsvWidget({super.key});

  @override
  State<TrayCsvWidget> createState() => _TrayCsvWidgetState();
}

class _TrayCsvWidgetState extends State<TrayCsvWidget> {
  late TrayCsvModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrayCsvModel());
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if ((_model.apiResult9bv?.succeeded ??
                                      true)) {
                                    await actions.downloadCSVtray(
                                      AdminApiGroup.listOfTrayWithoutTypeCall
                                          .records(
                                            (_model.apiResult9bv?.jsonBody ??
                                                ''),
                                          )
                                          ?.toList(),
                                      'LeapmileRobotics_tray_CSV',
                                    );
                                  } else {
