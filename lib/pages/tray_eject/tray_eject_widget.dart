...
import 'tray_eject_model.dart';
export 'tray_eject_model.dart';

class TrayEjectWidget extends StatefulWidget {
  const TrayEjectWidget({super.key});

  @override
  State<TrayEjectWidget> createState() => _TrayEjectWidgetState();
}

class _TrayEjectWidgetState extends State<TrayEjectWidget> {
  late TrayEjectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrayEjectModel());
