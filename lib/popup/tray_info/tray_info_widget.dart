...
import 'tray_info_model.dart';
export 'tray_info_model.dart';

class TrayInfoWidget extends StatefulWidget {
  const TrayInfoWidget({super.key});

  @override
  State<TrayInfoWidget> createState() => _TrayInfoWidgetState();
}

class _TrayInfoWidgetState extends State<TrayInfoWidget> {
  late TrayInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrayInfoModel());
