...
class QRSlotScan extends StatefulWidget {
  const QRSlotScan({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<QRSlotScan> createState() => _QRSlotScanState();
}

class _QRSlotScanState extends State<QRSlotScan> {
        ...
        children: [
          MobileScanner(
            ...
            onDetect: (barcodeCapture) async {
              ...
              if (code != null) {
                FFAppState().slotid = code; // Store scanned value in slotid
                await _playSound1();
              } else {
